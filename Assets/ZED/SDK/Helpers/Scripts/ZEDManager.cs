...
{
    public static Vector3 offsetZEDTransform;
    public static Quaternion offsetZEDRotation;
    ...
    /// </summary>
    protected Quaternion zedOrientation = Quaternion.identity;
    /// <summary>
    /// Position last returned by the ZED's tracking.
    /// </summary>
	protected Vector3 zedPosition = Vector3.zero;
    ...
    /// </summary>
	protected Transform zedRigRoot = null;
...
//                pathSpatialMemory = "";
            ...
            if (!(enableTracking = (zedCamera.EnableTracking(ref zedOrientation, ref zedPosition, enableSpatialMemory,
                enablePoseSmoothing, estimateInitialPosition, trackingIsStatic, enableIMUFusion, "") == sl.ERROR_CODE.SUCCESS)))
            {
    ...
    void OnValidate()
    {
        if (zedCamera != null)
        {
            ...
            if (isTrackingEnable && !enableTracking)
            {
                ...
                lock (zedCamera.grabLock)
                {
                    zedCamera.DisableTracking(pathSpatialMemory);
                }
