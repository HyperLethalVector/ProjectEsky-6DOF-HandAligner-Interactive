...
namespace Esky.Calibrator
{
    public class TrackerAlignerUI : MonoBehaviour
    {
        ...
        public ProjectEsky.Renderer.NorthstarV2NativeRenderer myrendererDriver;
        ...
        void Update()
        {
            if(Input.GetKey(KeyCode.N)){
                myrendererDriver.Tracker.localPosition += new Vector3(0 ,0, 1.0f*translationAdjustmentSpeed*Time.deltaTime );                
            }
            if(Input.GetKey(KeyCode.M)){
                myrendererDriver.Tracker.localPosition -= new Vector3(0 ,0, 1.0f*translationAdjustmentSpeed*Time.deltaTime );                
            }            
            if(Input.GetKey(KeyCode.UpArrow)){
                myrendererDriver.Tracker.localPosition += new Vector3(0 ,1.0f*translationAdjustmentSpeed*Time.deltaTime , 0);
            }
            if(Input.GetKey(KeyCode.LeftArrow)){
                myrendererDriver.Tracker.localPosition += new Vector3(-1.0f*translationAdjustmentSpeed*Time.deltaTime , 0 , 0);
            }            
